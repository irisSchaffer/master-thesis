...
As an end note on React, and a transition to the architecture of the application, I want to add that React components can be nested in each other, which is at the core of the project developed for the present thesis. To make it as easy as possible for other developers to use the created libraries, a presentation is built like a usual HTML page, using JSX to reference the custom React components:
%
\begin{JsCode}
<UnveilApp}>
  <Slide name="start">
