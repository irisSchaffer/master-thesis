...
% contributions:
% - analysis of presentations, finding design recommendations for interactive mechanisms
% - implementation of presentation software following these recommendations
% - creation of modular, open-source ecosystem which can  be used and extended by other developers
% - (informal evaluation of said software)
