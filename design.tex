...
\begin{figure}
\centering
\includegraphics[width=.8\textwidth]{wireframes/projector-interface}
...
\begin{figure}
\centering
\includegraphics[width=.8\textwidth]{wireframes/listener-interface}
...
\begin{figure}
\centering
\includegraphics[width=.8\textwidth]{wireframes/speaker-interface}
...
\begin{figure}
\centering
\includegraphics[width=.8\textwidth]{wireframes/modal-interface}
